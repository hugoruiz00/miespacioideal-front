...
export const ResponsiveNavLink = ({children, to, className, customActive = null, ...props}) => {
  ...
  const getClasses = (isActive) => {
    const active = customActive ? location.pathname.startsWith(customActive) : isActive;
    const baseClasses = active ? defaultClasses['active'] : defaultClasses['notActive'];
